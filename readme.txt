...
NCAAF D1A Team Stats allows bloggers display an NCAAF D1A team's standings within their sidebar.

== Description ==

NCAAF D1A Team Stats plugin can be added to any blog with a dynamic sidebar. Once installed, the blogger can choose their favorite NCAAF D1A Team. The stats are updated each week of the NCAAF D1A regular season, so that blog 
visitors can keep track of all the important NCAAF D1A team standings and stats. Additionally, teams qualifying for post-season play are denoted automatically in each stats table with the the standard NCAAF D1A *, x,y or z symbols.
...
1. Upload `ncaaf-d1a-team-stats` folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. The Plugin will automatically install a new option entry in your wp.options database table.
4. Go to your Design section and select the NCAAF D1A Stats widget.
...
= Why is there so much "inline" CSS displayed in my NCAAF D1A Stats table? =
